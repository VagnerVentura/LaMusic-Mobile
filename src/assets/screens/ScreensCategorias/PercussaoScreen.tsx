...
const produtos = [
  { id: '1', nome: 'Bateria', preco: 'R$200', imageUrl: require ('../../img/percussao/bateria1.png') },
  { id: '2', nome: 'Bateria', preco: 'R$300', imageUrl: require ('../../img/percussao/bateria2.png') },
//   { id: '3', nome: 'Violão', preco: 'R$1.289,00', imageUrl: require ('../../img/cordas/guitarra1.png') },
//   { id: '4', nome: 'Guitarra', preco: 'R$4.147,00', imageUrl: require ('../../img/cordas/guitarra.png') },
];
