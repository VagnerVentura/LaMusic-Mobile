...
const produtos = [
  { id: '1', nome: 'Guitarra', preco: 'R$200', imageUrl: require ('../../img/acessorios/acessorio1.png') },
  { id: '2', nome: 'Violão', preco: 'R$300', imageUrl: require ('../../img/acessorios/acessorio2.png') },
  { id: '3', nome: 'Violão', preco: 'R$1.289,00', imageUrl: require ('../../img/acessorios/acessorio3.png')},
  { id: '4', nome: 'Guitarra', preco: 'R$4.147,00', imageUrl: require ('../../img/acessorios/acessorio1.png') },
];
